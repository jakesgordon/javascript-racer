...
function refreshTweakUI() {
  ...
  Dom.get("currentRoadWidth").innerHTML = Dom.get(
    "roadWidth"
  ).value = roadWidth;
  Dom.get("currentCameraHeight").innerHTML = Dom.get(
    "cameraHeight"
  ).value = cameraHeight;
  Dom.get("currentDrawDistance").innerHTML = Dom.get(
    "drawDistance"
  ).value = drawDistance;
  Dom.get("currentFieldOfView").innerHTML = Dom.get(
    "fieldOfView"
  ).value = fieldOfView;
  Dom.get("currentFogDensity").innerHTML = Dom.get(
    "fogDensity"
  ).value = fogDensity;
}
